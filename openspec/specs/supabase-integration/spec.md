...
Supabase Auth SHALL have Site URL and redirect URLs configured for local development (`http://localhost:3000`) and production deployment targets documented in `.env.example`.
