...
const CtaSection: React.FC = () => {
  return (
    <section className="relative py-32 text-center overflow-hidden">
      {/* Dynamic Background */}
      <div className="absolute inset-0 bg-gradient-to-t from-padel-green/10 to-[#050505] z-0"></div>

      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-6xl md:text-8xl font-display font-bold leading-none mb-8">
            EL PÁDEL ESTÁ EVOLUCIONANDO. <br />
            <span className="text-padel-green">¿Y TÚ?</span>
          </h2>
          <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto mb-12 font-light tracking-wide">
            ...
            Sé el primero en probar la experiencia PadelGo.
          </p>
